controladdin "Text Editor Addin ACK"
{
    StyleSheets = 'Addins/TextEditorAddin/css/style.css',
    ...
    Scripts = 'https://code.jquery.com/jquery-3.3.1.min.js',
              ...
              'Addins/TextEditorAddin/js/startup.js';

    internal procedure LoadContents(Contents: Text);
